...
if (is_shop()) {
  ...
  <?php if ($cat->term_id == 437): // каталог внутриаптечные прописи с фильтром 3 карточки ?>
    <div class="rubriki-page archive-product custom-page has-filter">
  <?php elseif ($cat->term_id == 444) : // обычный каталог без фильтра 4 карточки обучение ?>
    <div class="archive-product single__prod">
  <?php else : // обычный каталог с фильтром 3 карточки ?>
