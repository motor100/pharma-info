...
function add_content_after_order_table( $order, $sent_to_admin, $plain_text, $email ) {
    if ( $email->id == 'customer_processing_order' ) {
        ...
        echo '<strong><a href="'. $site_url .'/wp-content/themes/store-child/includes/pdf/email/'. $rand . '.pdf' .'" download>Скачать PDF</a><strong><p></p><br>';

        echo 'Приглашаем Вас поработать с цветом и своим внутренним состоянием.<br>
        В прикрепленном файле Вы найдете Мандалу определенной цветочной эссенции Баха. Мандалы отправляются рандомно, но в этом мире нет ничего случайного. Вы можете внимательно изучить описание эссенции (раздел «Эссенции цветов Баха» на сайте Аптеки) и попробовать найти это состояние в себе.<br>
        Мандалы созданы и предоставлены флоротерапевтом, врачом натуропатом Альбиной Аоки. Они позволяют погрузиться в совершенное единение со своей душой и успокоить разум, немного отдохнуть и перезагрузиться.<br>
        ...
        Рандомные Мандалы не предназначены для диагностики и лечения. Но у Вас всегда есть возможность обратиться к специалисту (раздел «Специалисты» на сайте Аптеки) и заказать цветочные эссенции Баха.<br>
